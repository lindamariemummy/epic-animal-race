...
var rabbit = new Animal("Peter Rabbit",  1, 0.7, 0.6,"<img src='https://openclipart.org/people/rones/Rabbit_by_Rones.svg' height='20' width='20'/>");
...
var wolf = new Animal("Ralph the Wolf",    5, 0.8, 0.4, "<img src='https://openclipart.org/people/worldlabel/Lone%20Wolf.svg' height='20' width='20'/>");
var elephant = new Animal("Elsa the Elephant", 7, 0.7, 0.2, "<img src='https://openclipart.org/people/lemmling/lemmling_2D_cartoon_elephant.svg' height='20' width='20'/>");
...
function Course(courseLength, numLanes) {
	...
	this.adjacentLocation = function(location1, location2) {
		if (location1.getLane() == location2.getLane() && 
			(location1.getDistance() >= location1.getDistance() - 1 ||  location1.getDistance() <= location2.getDistance() + 1) ||
